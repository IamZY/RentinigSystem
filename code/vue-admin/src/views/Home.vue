        ...
        <el-col :span="24" class="header">
            ...
            <el-col :span="4" class="userinfo">
                <el-dropdown trigger="hover">
                    <span class="el-dropdown-link userinfo-inner"><img src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png"/> {{sysUserName}}</span>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            // 数据字典 area
            sessionStorage.setItem("region", this.area);
